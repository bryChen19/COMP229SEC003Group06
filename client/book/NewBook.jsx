...
import {create} from './api-book.js'
...
export default function Newbook({match}) {
  ...
  const clickSubmit = () => {
    ...
    if (values.redirect) {
      return (<Redirect to={'/librarian/shop/edit/'+match.params.shopId}/>)
    }
    return (<div>
      <Card className={classes.card}>
        ...
        <CardActions>
          ...
          <Link to={'/librarian/shop/edit/'+match.params.shopId} className={classes.submit}><Button variant="contained">Cancel</Button></Link>
        </CardActions>
      </Card>
    </div>)
}
