            ...
            return <span key={i}>
              <Card className={classes.card}>
                <CardMedia
                  ...
                  image={'/api/book/image/'+item._id}
                  title={item.name}
                />
                <div className={classes.details}>
                  <CardContent className={classes.content}>
                    <Link to={'/book/'+item._id}><Typography variant="h3" component="h3" className={classes.bookTitle} color="primary">{item.name}</Typography></Link>
